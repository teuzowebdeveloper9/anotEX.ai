...
import { OpenAiStudyMaterialProviderImpl } from './infrastructure/providers/openai-study-material.provider.impl.js';
...
@Module({
  ...
  providers: [
    ...
    { provide: STUDY_MATERIAL_PROVIDER, useClass: OpenAiStudyMaterialProviderImpl },
